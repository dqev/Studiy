...
export function UserDashboard() {
    ...
    const stats = [
        { label: 'Resources', value: userMaterials.length.toString(), icon: Notebook, color: 'text-blue-600', bg: 'bg-blue-50' },
        ...
        <div className="space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Welcome to your learning dashboard.</p>
                </div>
                    ...
                    <CardContent className="space-y-6">
                        <div>
                            <div className="flex justify-between mb-2">
                                ...
                                <span className="text-sm text-slate-500">{userMaterials.length} of 10</span>
                            </div>
                            <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
                                <div
                                    className="h-full bg-indigo-600 transition-all duration-300"
                                    style={{ width: `${Math.min((userMaterials.length / 10) * 100, 100)}%` }}
                                />
                            </div>
                        </div>
                        <Button
                        ...
                        <div className="border-t pt-4">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <p className="text-xs text-slate-500">Your Achievements</p>
                            </div>
                            <div className="space-y-2">
                                <div className="flex items-center text-sm">
                                    <CheckCircle2 className="h-5 w-5 rounded-full bg-indigo-100 text-indigo-700 mr-2" />
                                    <span className="text-slate-700">First Upload</span>
                                </div>
                                <div className="flex items-center text-sm">
                                    <Circle className="h-5 w-5 text-slate-400 mr-2" />
                                    <span className="text-slate-500">10 Uploads</span>
                                </div>
                            </div>
                        </div>
                    </CardContent>
